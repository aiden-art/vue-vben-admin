...
- The icons in the project are mainly provided by the `@oasis/icons` package. It is recommended to manage them within this package for unified management and maintenance.
...
import { createIconifyIcon } from '@oasis-core/icons';
...
import { MdiKeyboardEsc } from '@oasis/icons';
</script>
...
```vue
<script setup lang="ts">
import { SvgTestIcon } from '@oasis/icons';
</script>
