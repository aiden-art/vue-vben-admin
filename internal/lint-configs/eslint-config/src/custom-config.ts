...
const customConfig: Linter.Config[] = [
  ...
  {
    // @core/shared内部组件，不能引入@oasis/* 或者 @oasis-core/* 里面的包
    ...
    rules: {
      'no-restricted-imports': [
        'error',
        {
          patterns: [
            {
              group: ['@oasis/*', '@oasis-core/*'],
              message:
                'The @oasis-core/shared package cannot import the @vben package, please use the @core/shared package itself',
            },
          ],
        },
      ],
