...
import type { TabDefinition } from '@oasis/types';

import type { IContextMenuItem } from '@oasis-core/tabs-ui';

import { computed, ref, watch } from 'vue';
import { useRoute, useRouter } from 'vue-router';

import { useContentMaximize, useTabs } from '@oasis/hooks';
import {
  ArrowLeftToLine,
  ArrowRightLeft,
  ArrowRightToLine,
...
import { $t, useI18n } from '@oasis/locales';
import { getTabKey, useAccessStore, useTabbarStore } from '@oasis/stores';
import { filterTree } from '@oasis/utils';
