...
import { useForwardPropsEmits } from '@oasis-core/composables';
import { ChevronLeft, ChevronRight } from '@oasis-core/icons';
import { VbenScrollbar } from '@oasis-core/shadcn-ui';
