...
import type { Recordable } from '@oasis-core/typings';

import type { AlertProps, BeforeCloseScope, PromptProps } from './alert';

import { h, nextTick, ref, render } from 'vue';

import { useSimpleLocale } from '@oasis-core/composables';
import { Input, VbenRenderContent } from '@oasis-core/shadcn-ui';
import { isFunction, isString } from '@oasis-core/shared/utils';
